...
const UniversalEditorActionGenerator = require('./generator-add-action-universal-editor')
const UniversalEditorWebAssetsGenerator = require('./generator-add-web-assets-universal-editor')
...
class MainGenerator extends Generator {
  ...
  initializing () {
    ...
    this.extFolder = 'src/universal-editor-ui-1'
    ...
    this.configName = 'universal-editor/ui/1'
