...
class UniversalEditorWebAssetsGenerator extends Generator {
  ...
  writing () {
    ...
    this._generateRailFiles('rightPanel')
  ...
  _generateRailFiles(extensionArea) {
    ...
    rightPanelRails.forEach((panel) => {
        ...
        */
        ...
        this.fs.copyTpl(
          this.templatePath(relativeTemplatePath),
          this.destinationPath(path.join(this.destFolder, `./src/components/${railFileName}.js`)), {
            functionName: railFileName,
            extensionArea: extensionArea
          }
        )
      }
...
module.exports = UniversalEditorWebAssetsGenerator
